 ...
 * Time: 1:49:56 PM
 */
public class BestOfMarketHandler extends MIDletHandler {

    private static Logger logger = Logger.getLogger(BestOfMarketHandler.class);
    private TradingMessage tradingMessage;

    public BestOfMarketHandler(TradingMessage tradingMessage) {
    ...
    public TradingMessage handleRequest() throws Exception {
        ...
        if(userSession != null) {
            responseBody = MarketManager.bestOfMarketService(tradingMessage, pageNo, pageSize, status);
