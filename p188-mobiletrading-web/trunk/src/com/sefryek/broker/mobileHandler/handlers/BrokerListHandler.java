 ...
 * Time: 12:13:35 PM
 */
public class BrokerListHandler extends MIDletHandler {

    private static Logger logger = Logger.getLogger(BrokerListHandler.class);
    private TradingMessage tradingMessage;

    public BrokerListHandler(TradingMessage tradingMessage) {
...
//        }
        ...
        responseBody = new  MarketManager().getBrokerList(tradingMessage);
