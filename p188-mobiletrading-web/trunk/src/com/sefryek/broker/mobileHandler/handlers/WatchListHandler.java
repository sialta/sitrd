 ...
 * Time: 12:13:35 PM
 */
public class WatchListHandler extends MIDletHandler {

    private static Logger logger = Logger.getLogger(WatchListHandler.class);
    private TradingMessage tradingMessage;

    public WatchListHandler(TradingMessage tradingMessage) {
    ...
    public TradingMessage handleRequest() throws Exception {
        ...
        if(userSession != null) {
            responseBody = MarketManager.watchListService(tradingMessage, stockIds);
