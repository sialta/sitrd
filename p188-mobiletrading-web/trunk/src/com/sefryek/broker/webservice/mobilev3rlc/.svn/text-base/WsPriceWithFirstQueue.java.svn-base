...
public class WsPriceWithFirstQueue  extends com.sefryek.broker.webservice.mobilev3rlc.WsPrice  implements java.io.Serializable {
    private com.sefryek.broker.webservice.mobilev3rlc.WsQueue queueFirstRow;
    ...
    public WsPriceWithFirstQueue(
           ...
           com.sefryek.broker.webservice.mobilev3rlc.WsQueue queueFirstRow) {
        super(
            date,
            time,
            isNegative,
     ...
     */
    public com.sefryek.broker.webservice.mobilev3rlc.WsQueue getQueueFirstRow() {
        return queueFirstRow;
    }
     ...
     * @param queueFirstRow
     */
    public void setQueueFirstRow(com.sefryek.broker.webservice.mobilev3rlc.WsQueue queueFirstRow) {
        this.queueFirstRow = queueFirstRow;
    }
