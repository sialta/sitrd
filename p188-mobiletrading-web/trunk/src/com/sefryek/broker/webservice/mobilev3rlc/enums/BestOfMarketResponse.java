package com.sefryek.broker.webservice.mobilev3rlc.enums;
...
public class BestOfMarketResponse {
    ...
    public int FixItemsLen = 42;
    public int NSCCode = 12;
    public int BestBuyPrice = 4;
    public int BestSellPrice = 4;
    public int LastTradedPrice = 4;
    public int PriceChange = 3;
    public int PriceVarReal = 4;
    public int PriceVarMantissa = 1;
    public int ClosingPrice = 4;
    public int ClosingPriceVarReal = 4;
    public int ClosingPriceVarMantissa = 1;
    public int Status = 1;
}
