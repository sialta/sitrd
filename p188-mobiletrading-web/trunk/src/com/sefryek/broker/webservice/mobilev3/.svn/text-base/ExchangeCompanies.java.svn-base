...
public class ExchangeCompanies  implements java.io.Serializable {
    private com.sefryek.broker.webservice.mobilev3.ExchangeBoards exchangeBoard;
    ...
    public ExchangeCompanies(
           com.sefryek.broker.webservice.mobilev3.ExchangeBoards exchangeBoard,
     ...
     */
    public com.sefryek.broker.webservice.mobilev3.ExchangeBoards getExchangeBoard() {
        return exchangeBoard;
    }
     ...
     * @param exchangeBoard
     */
    public void setExchangeBoard(com.sefryek.broker.webservice.mobilev3.ExchangeBoards exchangeBoard) {
        this.exchangeBoard = exchangeBoard;
    }
