...
public class WS_MobileV3Locator extends org.apache.axis.client.Service implements com.sefryek.broker.webservice.mobilev3.WS_MobileV3 {
    ...
    public com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType getWS_MobileV3Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType getWS_MobileV3Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap12Stub _stub = new com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap12Stub(portAddress, this);
    ...
    public com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType getWS_MobileV3Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType getWS_MobileV3Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_BindingStub _stub = new com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap12Stub _stub = new com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap12Stub(new java.net.URL(WS_MobileV3Soap12_address), this);
                _stub.setPortName(getWS_MobileV3Soap12WSDDServiceName());
                return _stub;
            }
            if (com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_BindingStub _stub = new com.sefryek.broker.webservice.mobilev3.WS_MobileV3Soap_BindingStub(new java.net.URL(WS_MobileV3Soap_address), this);
                _stub.setPortName(getWS_MobileV3SoapWSDDServiceName());
                return _stub;
            }
        }
