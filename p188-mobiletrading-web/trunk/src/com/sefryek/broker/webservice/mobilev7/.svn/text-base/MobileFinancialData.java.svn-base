...
public class MobileFinancialData  implements java.io.Serializable {
    ...
    private com.sefryek.broker.webservice.mobilev7.NameData[] names;
    ...
    public MobileFinancialData(
           ...
           int financialId,
           com.sefryek.broker.webservice.mobilev7.NameData[] names) {
           this.name = name;
    ...
    /**
     * Gets the names value for this MobileFinancialData.
     * 
     * @return names
     */
    public com.sefryek.broker.webservice.mobilev7.NameData[] getNames() {
        return names;
    }


    /**
     * Sets the names value for this MobileFinancialData.
     * 
     * @param names
     */
    public void setNames(com.sefryek.broker.webservice.mobilev7.NameData[] names) {
        this.names = names;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "Names"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "NameData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://tempuri.org/", "NameData"));
        typeDesc.addFieldDesc(elemField);
    }
