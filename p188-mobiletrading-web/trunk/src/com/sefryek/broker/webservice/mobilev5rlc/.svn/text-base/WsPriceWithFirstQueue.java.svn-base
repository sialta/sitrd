...
public class WsPriceWithFirstQueue  extends com.sefryek.broker.webservice.mobilev5rlc.WsPrice  implements java.io.Serializable {
    private com.sefryek.broker.webservice.mobilev5rlc.WsQueue queueFirstRow;
    ...
    public WsPriceWithFirstQueue(
           ...
           com.sefryek.broker.webservice.mobilev5rlc.WsQueue queueFirstRow,
     ...
     */
    public com.sefryek.broker.webservice.mobilev5rlc.WsQueue getQueueFirstRow() {
        return queueFirstRow;
    }
     ...
     * @param queueFirstRow
     */
    public void setQueueFirstRow(com.sefryek.broker.webservice.mobilev5rlc.WsQueue queueFirstRow) {
        this.queueFirstRow = queueFirstRow;
    }
