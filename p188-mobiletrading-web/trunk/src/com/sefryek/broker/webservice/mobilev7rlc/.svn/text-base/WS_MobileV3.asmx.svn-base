...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://tempuri.org/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" targetNamespace="http://tempuri.org/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://tempuri.org/">
        ...
        <s:complexContent mixed="false">
          <s:extension base="tns:WsPrice">
            <s:sequence>
              ...
              <s:element minOccurs="1" maxOccurs="1" name="ClosingPriceVar" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="ClosingPriceChange" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="MaxQuantityOrder" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="MinQuantityOrder" type="s:decimal" />
              <s:element minOccurs="1" maxOccurs="1" name="TotalNumberOfTrades" type="s:long" />
      ...
      <s:element name="GetWatchListNew">
        <s:complexType>
          <s:sequence>
      ...
      <s:element name="GetWatchListNewResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetWatchListNewResult" type="tns:ArrayOfWsPriceWithFirstQueue" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:element name="GetBrokerList">
        <s:complexType />
      </s:element>
      <s:element name="GetBrokerListResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetBrokerListResult" type="tns:ArrayOfWsMobileBroker" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="ArrayOfWsMobileBroker">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="unbounded" name="WsMobileBroker" nillable="true" type="tns:WsMobileBroker" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="WsMobileBroker">
        <s:sequence>
      ...
      <s:element name="GetSymbolHistoryData">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="request" type="tns:HistoryRequest" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="HistoryRequest">
        <s:sequence>
          ...
          <s:element minOccurs="1" maxOccurs="1" name="TimePart" type="s:int" />
        </s:sequence>
      </s:complexType>
      <s:element name="GetSymbolHistoryDataResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetSymbolHistoryDataResult" type="tns:ArrayOfSymbolHistory" />
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:complexType name="ArrayOfSymbolHistory">
        <s:sequence>
          <s:element minOccurs="0" maxOccurs="unbounded" name="SymbolHistory" nillable="true" type="tns:SymbolHistory" />
        </s:sequence>
      </s:complexType>
      <s:complexType name="SymbolHistory">
        <s:sequence>
  ...
  <wsdl:message name="GetWatchListNewSoapIn">
    <wsdl:part name="parameters" element="tns:GetWatchListNew" />
  </wsdl:message>
  <wsdl:message name="GetWatchListNewSoapOut">
    <wsdl:part name="parameters" element="tns:GetWatchListNewResponse" />
  </wsdl:message>
  <wsdl:message name="GetBrokerListSoapIn">
    <wsdl:part name="parameters" element="tns:GetBrokerList" />
  </wsdl:message>
  <wsdl:message name="GetBrokerListSoapOut">
    <wsdl:part name="parameters" element="tns:GetBrokerListResponse" />
  </wsdl:message>
  <wsdl:message name="GetSymbolHistoryDataSoapIn">
    <wsdl:part name="parameters" element="tns:GetSymbolHistoryData" />
  </wsdl:message>
  <wsdl:message name="GetSymbolHistoryDataSoapOut">
    <wsdl:part name="parameters" element="tns:GetSymbolHistoryDataResponse" />
  </wsdl:message>
  ...
  <wsdl:portType name="WS_MobileV3Soap">
    ...
    <wsdl:operation name="GetWatchListNew">
      <wsdl:input message="tns:GetWatchListNewSoapIn" />
      <wsdl:output message="tns:GetWatchListNewSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="GetBrokerList">
      <wsdl:input message="tns:GetBrokerListSoapIn" />
      <wsdl:output message="tns:GetBrokerListSoapOut" />
    </wsdl:operation>
    <wsdl:operation name="GetSymbolHistoryData">
      <wsdl:input message="tns:GetSymbolHistoryDataSoapIn" />
      <wsdl:output message="tns:GetSymbolHistoryDataSoapOut" />
    </wsdl:operation>
  ...
  <wsdl:binding name="WS_MobileV3Soap" type="tns:WS_MobileV3Soap">
    ...
    <wsdl:operation name="GetWatchListNew">
      <soap:operation soapAction="http://tempuri.org/GetWatchListNew" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetBrokerList">
      <soap:operation soapAction="http://tempuri.org/GetBrokerList" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetSymbolHistoryData">
      <soap:operation soapAction="http://tempuri.org/GetSymbolHistoryData" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WS_MobileV3Soap12" type="tns:WS_MobileV3Soap">
    ...
    <wsdl:operation name="GetWatchListNew">
      <soap12:operation soapAction="http://tempuri.org/GetWatchListNew" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetBrokerList">
      <soap12:operation soapAction="http://tempuri.org/GetBrokerList" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetSymbolHistoryData">
      <soap12:operation soapAction="http://tempuri.org/GetSymbolHistoryData" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="WS_MobileV3">
    <wsdl:port name="WS_MobileV3Soap" binding="tns:WS_MobileV3Soap">
      <soap:address location="http://tadbirrlc.com/WebService/WS_MobileV3.asmx" />
    </wsdl:port>
    <wsdl:port name="WS_MobileV3Soap12" binding="tns:WS_MobileV3Soap12">
      <soap12:address location="http://tadbirrlc.com/WebService/WS_MobileV3.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>