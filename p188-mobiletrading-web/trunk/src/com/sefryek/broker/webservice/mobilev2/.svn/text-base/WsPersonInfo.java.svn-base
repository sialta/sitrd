...
public class WsPersonInfo  implements java.io.Serializable {
    ...
    private com.sefryek.broker.webservice.mobilev2.Remain remain;
    ...
    public WsPersonInfo(
           ...
           com.sefryek.broker.webservice.mobilev2.Remain remain) {
     ...
     * @return remain
     */
    public com.sefryek.broker.webservice.mobilev2.Remain getRemain() {
        return remain;
    }
     ...
     * @param remain
     */
    public void setRemain(com.sefryek.broker.webservice.mobilev2.Remain remain) {
        this.remain = remain;
    }
