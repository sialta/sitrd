...
public class JalaliTimeZone extends TimeZone {
     ...
     * uses a default {@link JalaliCalendar} object as its
     * underlying calendar, such as for determining leap years.  Do
     * not use the result of this method with a calendar other than a
     * default <code>JalaliCalendar</code>.
     *
    ...
    public int getOffset(int era, int year, int month, int day, int dayOfWeek,
        ...
        if (month < JalaliCalendar.FARVARDIN
                || month > JalaliCalendar.ESFAND) {
            throw new IllegalArgumentException("Illegal month " + month);
        }
        int monthLength, prevMonthLength;
        if ((era == JalaliCalendar.AH) && internalCal.isLeapYear(year)) {
    ...
    int getOffset(int era, int year, int month, int day, int dayOfWeek,
        ...
        if (true) {
             ...
             * file.  */
            if ((era != JalaliCalendar.AH && era != JalaliCalendar.BH)
                    || month < JalaliCalendar.FARVARDIN
                    || month > JalaliCalendar.ESFAND
                    || day < 1
                    || day > monthLength
        ...
        if (!useDaylight || year < startYear || era != JalaliCalendar.AH) return result;
    ...
    public boolean inDaylightTime(Date date) {
        JalaliCalendar jc = new JalaliCalendar(this);
        jc.setTime(date);
     ...
     * between <code>JalaliCalendar.FARVARDIN</code> and
     * <code>JalaliCalendar.ESFAND</code> inclusive.  This value must not equal
     * <code>endMonth</code>.
     ...
     * <code>startDayOfWeek</code> of <code>Calendar.SATURDAY</code> indicates the
     ...
     * between <code>JalaliCalendar.FARVARDIN</code> and
     * <code>JalaliCalendar.ESFAND+1</code>.  This value must not equal
     * <code>startMonth</code>.
     * <p>If <code>useDaylight</code> is false, this value is ignored.
     * @serial
     */
     ...
     * <code>endDayOfWeek</code> of <code>Calendar.SATURDAY</code> indicates the
    ...
    private static JalaliCalendar internalCal = new JalaliCalendar();
     ...
     * really specific to JalaliCalendar, which does not use that month.
    ...
    private void decodeStartRule() {
        ...
        if (startDay != 0) {
            if (startMonth < JalaliCalendar.FARVARDIN || startMonth > JalaliCalendar.ESFAND) {
                throw new IllegalArgumentException(
    ...
    private void decodeEndRule() {
        useDaylight = (startDay != 0) && (endDay != 0);
        if (endDay != 0) {
            if (endMonth < JalaliCalendar.FARVARDIN || endMonth > JalaliCalendar.ESFAND) {
                throw new IllegalArgumentException(
    ...
    private void readObject(ObjectInputStream stream)
        ...
        if (serialVersionOnStream < 1) {
            ...
            if (startDayOfWeek == 0) startDayOfWeek = Calendar.SATURDAY;
            if (endDayOfWeek == 0) endDayOfWeek = Calendar.SATURDAY;
