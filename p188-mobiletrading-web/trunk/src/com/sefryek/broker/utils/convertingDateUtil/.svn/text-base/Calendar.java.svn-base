...
public abstract class Calendar implements Serializable, Cloneable {
    ...
    private void setWeekCountData(Locale desiredLocale) {
        ...
        if (data == null) {  /* cache miss */
            ...
            // get ResouceBundle and convert date and time for jdk1.4
//            ResourceBundle resource
//                    = ResourceBundle.getBundle("sun.text.resources.LocaleElements", desiredLocale);
...
//            data[1] = Integer.parseInt(dateTimePatterns[1]);
            ...
            // get ResouceBundle and convert date and time for jdk1.6            
            ResourceBundle resource
                    = ResourceBundle.getBundle("sun.util.resources.CalendarData", desiredLocale);
            data = new int[2];
            data[0] = Integer.parseInt(resource.getString("firstDayOfWeek"));
            data[1] = Integer.parseInt(resource.getString("minimalDaysInFirstWeek"));
